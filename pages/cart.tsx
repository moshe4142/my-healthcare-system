...
import { useTheme } from "@mui/material/styles"; // make sure this is imported
          ...
          <Grid item xs={12} key={item.id}>
            <Card
              sx={{
                ...
                border: `1px solid ${
                  theme.palette.mode === "dark" ? "#4fc3f7" : "#bbdefb"
                }`,
                transition: "0.3s",
                "&:hover": {
            ...
            >
              ...
              >
                ...
                <IconButton
                  ...
                  sx={{
                    bgcolor:
                      theme.palette.mode === "dark" ? "#3c2b2b" : "#ffe0e0",
                    color: "#c62828",
                    "&:hover": {
                      bgcolor:
                        theme.palette.mode === "dark" ? "#5a2a2a" : "#ffcccc",
                    },
                  }}
                >
                  <DeleteIcon />
